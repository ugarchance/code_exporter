...
class CodeExporterApp:
    ...
    def __init__(self, args):
        ...
        # Sadece komut satırında belirtilen klasörü kontrol et
        if self.args.dir:
            try:
                ...
                logging.error(f"Başlangıç klasörü açılırken hata: {e}")
    ...
    def setup_app(self) -> None:
        ...
        if hasattr(self, 'config_manager'):
            if self.args.theme == 'dark' or self.config_manager.get('dark_mode', False):
                setup_dark_theme(self.app)
        elif self.args.theme == 'dark':
            setup_dark_theme(self.app)
